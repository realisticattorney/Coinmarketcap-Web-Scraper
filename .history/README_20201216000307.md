...
For this project I created a web scraper that returns a list of prices and names for different types of assets you can choose from the program's welcome menu.
