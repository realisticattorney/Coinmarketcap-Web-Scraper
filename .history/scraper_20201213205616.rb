...
def scraper
   ...
   top_10.each do |top_currency|
      currency = {
         name: parsed_page.css('tbody tr td div.price___3rj7O a')[top_currency.to_i].attributes["href"].value,
         curr_price: prices = parsed_page.css('tbody tr td div.price___3rj7O a.cmc-link')[top_currency.to_i].text  
      }
      byebug
   end
end
