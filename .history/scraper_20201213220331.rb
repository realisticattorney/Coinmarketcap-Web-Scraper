...
def scraper
   ...
   while page <= last_page
      ...
      currencies_listing.each do |currency_|
      currency_ = i
      currency = {
         price: prices = parsed_page.css('tbody tr td div.price___3rj7O a.cmc-link')[currency_].text,
         name: parsed_page.css('tbody tr td div.price___3rj7O a')[currency_].attributes["href"].value
      }
      i += 1
      currencies << currency
      end
