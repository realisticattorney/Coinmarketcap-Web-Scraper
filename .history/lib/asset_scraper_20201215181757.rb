...
def scraper
   ...
   while page <= 3
      ...
      when 'Derivatives'
      currency = {
         price: pagination_parsed_page.css('tbody tr td div.price___3rj7O')[currency_index].textname: pagination_parsed_page.css('tbody tr td div.price___3rj7O a')[currency_index].text
      }
      puts currency
      when 'DeFi'
      currency = {
