...
def scraper
   ...
   top_10.each do |top_currency|
      currency = {
         name: parsed_page.css('tbody tr td div.price___3rj7O a').attributes["href"].value,
...
# instructions: if RuntimeError Exception: You want to finish 3 frames, but stack size is only 2 gem uninstall pry-byebug
