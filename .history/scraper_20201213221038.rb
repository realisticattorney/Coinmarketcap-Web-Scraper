...
def scraper
   ...
   while page <= last_page
      ...
      currency_index = i
      currency = {
         price: pagination_parsed_page.css('tbody tr td div.price___3rj7O a.cmc-link').text,
         name: pagination_parsed_page.css('tbody tr td div.price___3rj7O a').attributes["href"].value
      }
      i += 1
      currencies << currency
      end
